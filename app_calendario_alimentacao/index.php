...
<body id="login">
    <nav class="nav-bar bg-dark text-light">
        <h1>Calendário de alimentação</h1>
            ...
            <?php
                if(isset($_GET['erro']) && $_GET['erro'] == 'user_search'){
            ?>
            <article id="erroMessage" class="bg-danger d-flex justify-content-center">
                    <p class="text-light">Ocorreu um erro ao tentar logar. Verifique seu email e senha.</p>
            </article>
            <?php
                }
            ?>
    <main class="container d-flex justify-content-center align-items-center vh-100">
            <section id="container">
                ...
                <article class="d-flex justify-content-center form">
                    <form method="post" action="Controller/login.php?acao=logar">
                        ...
                        <aside class="form-group d-flex flex-row-reverse">
                            <input type="submit" class="btn btn-outline-dark" id="btn-submit" value="Logar">
                            <a href="singin.php" class="link-secondary link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover">Criar conta</a>
                        </aside>
                    </form>
                </article>
        </section>
